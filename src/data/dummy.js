...
export const EditorData = () => (
  <div>
    <h3>
    Welcome to your Editor! This page is designed to make content creation and editing seamless. Start by clicking Create New to begin a fresh document, or select an existing one to update. As you type, everything autosaves in real time, so you’ll never lose your work.

Formatting tools are available at the top of the editor, helping you apply styles, add links, or create lists to keep your content organized and professional. For quick navigation, use the search feature to find documents by keyword. You can also review past versions if you need to revert any changes.

Remember to keep titles clear and consistent, and don’t hesitate to experiment with formatting to make your content more engaging. Dive in, and enjoy the streamlined editing experience!
    </h3>
  </div>
);
